...
spacex_df = pd.read_csv("K:\git_repo\MainRepo\Data Sci\Capstone\spacex_launch_dash.csv")
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values=counts.values,
                names = ['Sucess','Failure'],
                title=f'Success vs. Failures to launch at site {entered_site}')
        return fig
